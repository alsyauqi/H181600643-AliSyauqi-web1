            ...
            <div class="card">
                ...
                <div class="card-body">
                    <form method="POST" action="{{ route('register') }}">
                        ...
                        <div class="form-group row">
                            <label for="email" class="col-md-4 col-form-label text-md-right">{{ __('Emaill Address') }}</label>
                        ...
                        <div class="col-md-6">
                        <select required="required" class="form-control form-control-sm" id="kategori" name="kategori"><option selected="selected" value=""<option value="1">Kelas A</option><option value="2">Kelas A</option><option value="3">Kelas B</option><option value="4">Kelas C</option>></select>
                        </div>
                        </div>
